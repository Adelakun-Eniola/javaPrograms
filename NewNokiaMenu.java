...
//		}
		...
		switch(number2){
			...
			switch(numberOneSubSection7){
				...
				switch(num2){
					...
					case 2:
					Syste m.out.println("Reply Via Same Centre"); break;
					case 3:
			...
			Scanner newMenu3 = new Scanner(System.in);
			System.out.println("Please Enter A Selection:");
			int number3 = newMenu3.nextInt();
		...
		String backPad = goBack.nextLine();
	...
	Scanner menu03 = new Scanner(System.in);
	System.out.println("Please Enter A Selection:");
	int number03 = menu03.nextInt();
		break;
		...
		case 9:
			...
			Scanner menu9 = new Scanner(System.in);
			System.out.println("Please Enter A Selection:");
			int number09 = menu9.nextInt();
	...
	Scanner menu05 = new Scanner(System.in);
	System.out.println("Please Enter A Selection:");
	int number__ = menu05.nextInt();
